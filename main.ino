...
// for one pair
void transform(int encoderDegreesWheels, int encoderDegreesLegs){

  // for resetting the wheels
  while(encoderDegreesWheels != 180){
    pwm.setPWM(0,3500,0);
    pwm.setPWM(1,0,4096);
    pwm.setPWM(2,3500,0);
    pwm.setPWM(3,0,4096);
  }
  // for resetting the legs
  while(encoderDegreesLegs != 0){
    pwm.setPWM(4,3500,0);
    pwm.setPWM(5,0,4096);
    pwm.setPWM(6,3500,0);
    pwm.setPWM(7,0,4096);
